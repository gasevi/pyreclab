...
PyMethodDef SlopeOne_methods[] =
{
   ...
   { "MAP",       (PyCFunction)SlopeOne_MAP,       METH_VARARGS|METH_KEYWORDS, "calculate Normalized Discounted Cumulative Gain for a user" },
   { "nDCG",      (PyCFunction)SlopeOne_nDCG,      METH_VARARGS|METH_KEYWORDS, "calculate Mean Average Precision for a user" },
   { NULL, NULL, 0, NULL }
};
