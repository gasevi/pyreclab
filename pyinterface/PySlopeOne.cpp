...
PyMethodDef SlopeOne_methods[] =
{
   ...
   { "precision", (PyCFunction)PyPrecision<PySlopeOne>, METH_VARARGS|METH_KEYWORDS, "calculate Precision for a user" },
   { "recall",    (PyCFunction)PyRecall<PySlopeOne>,    METH_VARARGS|METH_KEYWORDS, "calculate Recall for a user" },
   { "AUC",       (PyCFunction)PyAUC<PySlopeOne>,       METH_VARARGS|METH_KEYWORDS, "calculate Area Under the ROC Curve for a user" },
