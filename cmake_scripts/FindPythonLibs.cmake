...
if( ${CMAKE_SYSTEM_NAME} MATCHES "Linux" )
  ...
  if( ${CMAKE_PYTHON_VERSION} VERSION_LESS "3.8" )
  ...
  else( ${CMAKE_PYTHON_VERSION} VERSION_LESS "3.8")
    string( REGEX REPLACE "\\." "" ABI_TAG "cp${CMAKE_PYTHON_VERSION}" )
  endif( ${CMAKE_PYTHON_VERSION} VERSION_LESS "3.8")
...
elseif( ${CMAKE_SYSTEM_NAME} MATCHES "Linux" )
  set( ${PACKAGE_NAME}_LIBRARY_PATHS ${${PACKAGE_NAME}_LIBRARY_PATHS} /opt/python/${MANYLNX_SUBDIR}/lib/python${CMAKE_PYTHON_VERSION} )
