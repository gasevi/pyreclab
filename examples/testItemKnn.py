...
if __name__ == '__main__':
   ...
   start = time.clock()
   ibknn.train( k = 100, similarity = 'pearson', progress = True )
   end = time.clock()
   ...
   start = time.clock()
   recommendList, maprec, ndcg = ibknn.testrec( input_file = 'dataset/u1.test',
                                                dlmchar = b'\t',
                                                header = False,
                                                usercol = 0,
                                                itemcol = 1,
   ...
   mapUser10 = ibknn.MAP( user_id = '10', topn = 10, relevance_threshold = 2, include_rated = False )
   ndcgUser10 = ibknn.nDCG( user_id = '10', topn = 10, relevance_threshold = 2, include_rated = False  )
